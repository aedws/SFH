...
- When the user requests a progress check, read the authoritative SFH Notion planning page first, give explicitly confirmed requirements a higher weight than provisional requirements, verify completion against the repository, and update `docs/index.md` plus `docs/development-status.md` with the source and calculation basis.
