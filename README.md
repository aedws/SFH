...
K 화면에서 이동·전투·스킬·메뉴 21개 Action을 키보드나 마우스 버튼으로 자유롭게 바꿀 수 있습니다. 외부 VFX는 상업 이용이 확인된 CC0 파일만 반입하며 원문과 출처는 [라이선스 원장](https://aedws.github.io/SFH/architecture/third-party-assets/)에 공개합니다.
