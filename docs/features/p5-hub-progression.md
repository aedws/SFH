...
| 제작소 | 영구 등록 수·잠금/재제작 후보·재료·비용·옵션/소켓 범위 | P7-03 반출 도면 등록→재접속 유지→재제작 후보→보관함 추가 |
