...
1. 사용자용 1~9 키 설정 화면과 바인딩 영구 저장
2. 영구 상점 구매품을 I/U 인벤토리에 생성하는 전용 거점 화면
3. 4~9번 스킬과 지역별 고유 보스·드랍 콘텐츠
4. 서버 기반 조건부 랭킹 검증·신원·부정 방지
5. Google Sheets 밸런스 확정과 저사양 GPU·브라우저 실기 인증
