...
[SFH Web 빌드 바로 실행](https://sfh-game.vstock-market.workers.dev/)을 열면 Godot 설치 없이 현재 `main` 기준 프로토타입을 플레이할 수 있습니다. 데스크톱 Chrome·Edge·Whale 등 최신 Chromium 브라우저와 키보드, 1280×720 이상의 화면을 권장합니다.
...
메타데이터에는 빌드 커밋, Godot 4.7.2, CSV 데이터 버전과 Weapon·런 버프·업그레이드 CSV별 SHA-256이 기록됩니다. R2에는 GitHub Actions에서 게임·E2E·패키지 검증을 통과한 동일 파일만 업로드합니다.
