...
1. AP 회복·장비/스킬 소켓 귀속·훈련 룬의 소유 범위를 먼저 확정합니다. 제안은 AP 마지막 소모 후 1초 지연·초당 10 회복, 기존 드랍/충전 유지, 소켓은 대상별 효과 적용·해제 시 가방 반환·탈출 환전, 훈련 종료 원복입니다. **아직 승인된 정책이나 런타임 값이 아닙니다.**
...
4. 승인된 AP 정책 → 소켓 귀속 → 훈련 무료 세팅/종료 원복 순서로 연결하고 중복 효과·소유권·정산 회귀를 검증합니다.
