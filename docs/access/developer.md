...
<section class="sfh-role-console is-developer sfh-role-workspace">
  ...
  <div class="sfh-dev-focus">
    <span><small>NEXT</small><b>P6-04</b><em>마감 기록 기반 칭호·오라</em></span>
...
| 1 | P6-04 칭호·오라 | 지급은 보상 서비스, 소유는 프로필, 표현은 UI가 담당 | 1회 지급·재로그인 유지·장착 결과 확인 |
...
- **Phase 6 P6-01~03:** 로컬 보존, 공급자 어댑터, 익명 신원, 검증 봉투, 멱등·영구 재시도·거부 사유.
