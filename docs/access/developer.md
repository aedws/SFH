...
<section class="sfh-role-console is-developer sfh-role-workspace">
  ...
  <div class="sfh-dev-focus">
    <span><small>NEXT</small><b>P7-01B</b><em>실제 품질·실물 지급 · A 비교 구매 완료</em></span>
...
| 1 | P7-01B 품질·실물 연결 | 기존 ShopOffer/아이템 정의를 확장, 필요 목록은 Sheet 함께 갱신 | 실제 품질 성능·규격 가격·I/U 실물 장착 |
| 2 | P7-02~P10 | 회전/제작→훈련→도감→출시 후보 | 선행 패킷 완료 후 각 흐름 E2E와 산출물 동등성 |
...
| 적용 누락 | 상점 품질 배율은 데이터만 있고 구매는 창고 수량 지급 | UI에 미연결을 표시, 경제 진행도 100→70%·전체 추정 94%로 정정 |
