...
**9/23 후속 · 실물 보존 기반:** [가방 원본+보관 구획의 단일 저장 계약](../features/grid-inventory.md#reserve-20260923)을 추가했습니다. 거점 초안→저장/취소,36/48/60/72칸 이관→초과품 원형 보존, 재시작·사망 회귀를 분리합니다. **기본96칸과 기존 수량 창고는 유지**, 등급별 적용·파우치는 다음 단계입니다. [검증 근거](../quality/e2e-play-session.md#reserve-20260923).
