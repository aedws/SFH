...
**이번 변경:** 거점 훈련장은 단일·밀집 더미를 실제로 공격하면서 DPS·최대 타격·AP 소모율·평균 쿨타임을 같은 화면에 보여 줍니다. 훈련 중에는 장비·가방·스킬을 비용 없이 시험하고, 작전 준비나 훈련 종료 시 들어오기 전 세팅으로 돌아갑니다. 더미 체력·방어·수량·측정 시간은 아직 시험값이므로 기획 확정이 필요합니다.
