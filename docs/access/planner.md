...
**9/23 후속 · 거점에서 종결 장비를 만들 수 없게:** 제작은 기본 수치 옵션과1~2소켓 범위만 제공합니다. 새 심층 전용 품목은 거점 매물에서 제외하고, 기존 보유 장비는 그대로 둡니다. [무엇이 달라졌나/임시 G3 기준](../features/p5-hub-progression.md#supply-20260923). 실제 심층·수문장·키카드 금고는 다음 단계입니다. 희귀 등급 대응이나 기본 수치 허용 범위를 바꾸려면 Notion에 확정/임시와 근거를 적고 오너에게 메시지로 알려주세요.

**9/23 최신 · 가방36칸 + 보호 주머니4칸:** 넘치는 기존 물건은 삭제하지 않고 거점 실물 보관으로 옮깁니다. 도면·룬·코어·유물을 주머니에 넣고 **저장**하면 실패해도 거점에서 원형으로 찾을 수 있습니다. 생환하면 기존 해금/환전 규칙입니다. [그대로 따라 하는 사용법](../features/grid-inventory.md#pouch-20260923). 준비 가방이 차 있으면 거점 보관에 맡겨 회수 공간을 먼저 확보하세요.

**지금 필요한 판단은 확장 가격입니다:** [ContainerCapacity 시트](https://docs.google.com/spreadsheets/d/1dtQKVZiMf7VRFWrVnaL3BqzR0g4ZgEG6ueH9RIN3xqM/edit#gid=10923)의 가방48/60/72칸, 주머니6/8칸 비용 후보와6칸 중간 단계를 확인해 주세요. 아직 구매 잠금이며 후보 금액은 확정이 아닙니다. 예: “임시 승인 · 가방48칸1,000C · 초반2회 생환 수익으로 확장하도록 조정”. Notion에 값·상태·이유를 적고 **프로젝트 오너에게 개인 메시지로 갱신 사실을 알려 주세요.** 오너 승인 후 게임 반영합니다.

**9/23 먼저 볼 변화:** 작전은15~20분 안에 살아 돌아오는 것을 권장합니다. 20분부터 일반 적이 강해지고 Hunter가 추격하며30분에는 실패합니다. 일찍 탈출할 수는 있습니다. [동작·임시 배율](../features/extraction-defense-results.md#pressure-20260923)을 보고 ‘경고를 알아챘는지, 더 머물 보상이 충분했는지’를 알려 주세요. 가방/파우치·룬·요원/심층 미정 수치의 임시 구현은 오너가 승인했지만 아직 완성된 것은 아닙니다. [현재7구현·5부분·3미구현과 다음 순서](../design/current-milestone-workline.md#next-20260923). 아래 날짜별 안내는 당시 이력입니다.

**코어를 어느 스킬에 쓸지 직접 시험:** [가방의 적용 대상 선택](../features/session-sockets.md#target-selection-20260922)으로 두 번째·세 번째 스킬에도 코어를 장착할 수 있습니다. 기존 용량/효과는 유지합니다. 다음 확정에는 `스킬 ID→기본 소켓1/2`, `고급/심층 장비 추가 조건`, `룬 ID→형태/원소/트리거/유틸 효과·수치·중복 제한`이 필요합니다. 예시는 작성 형식일 뿐 확정값이 아닙니다. Notion에 정리 후 프로젝트 오너에게 갱신 사실을 알려 주세요.
...
**9/22 현재 변화:** [뱅가드 전술 적응](../features/character-selection.md#tactical-adaptation-20260922)을 반영했습니다. 기본 AP+15%·이동 중 자연 회복+20%이며, 기본 AP 수치 자체는 임시입니다.  작전 중 가방을 열어도 적과 시간이 멈추지 않습니다. 장착한 룬도 탈출 시 환전되는 기존 동작을 전용 시험으로 확인했습니다. [사용 방법과 위험 안내](../features/grid-inventory.md#realtime-20260922) · [다음 작업과 확인할 것](../design/current-milestone-workline.md#next-20260922). 신규15고유요구는 코드 구현5·부분5·미구현5이며 전체82행 완료율이나 재미 검증 완료율이 아닙니다. 훈련 라이브 동등성 수정은 완료했지만 실제 플레이 수락과 파우치·심층·혈전 등의 오너 판단은 남아 있습니다.

**요원·스킬 시험:** [초기 무장과 액티브 40종](../features/tactical-skill-catalog.md). 3요원의 고정 패시브가 자원 순환/기동/구역 유지로 특화합니다. 신규36종 수치는 임시이며 Skill은 자원, SkillPattern은 효과, Character는 특화를 조정합니다. 공용 액티브와 캐릭터 전용 제한의 차이, 적 제어 강도·상태 연계 보상을 시험한 뒤 Notion에 판단 이유를 남겨 주세요.
...
**아래는 최초 요청 이력과 후속 판단 목록입니다.** 9/23 오너 승인으로 가방 크기·보호품 종류·사망 원형 보존/성공 정산은 위 현행 기능에 반영했습니다. 파우치는 확장 가격과 중간 단계만 추가 판단이 필요합니다. 심층·룬·요원의 미정 수치는 교체 가능한 임시 정책으로 진행하되, 최종 적용 여부는 **프로젝트 오너**가 판단합니다. 아래 과거 예시는 승인값·현재 게임 규칙이 아닙니다.
