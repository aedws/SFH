...
**9/23 후속 · 장비를 그대로 맡기기:** 거점 I에서 아이템 선택→‘거점에 보관’→저장하면 옵션과 강화 상태 그대로 보관합니다. ‘거점 실물 보관’ 목록의 꺼내기로 되찾습니다. 전투 중에는 보관할 수 없으며 **사망해도 보존되는 현장 파우치가 아닙니다.** [쉬운 사용법과 다음 가방/파우치 범위](../features/grid-inventory.md#reserve-20260923). 기본96칸은 아직 유지합니다.
