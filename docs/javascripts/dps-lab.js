...
(() => {
  'use strict';
  const groups = [
    ['무기 시험값', [['damage','탄환 기본 피해'],['interval','마지막 발사 후 대기 (초)'],['crit','치명 확률 (0~1)'],['critMultiplier','치명 배율']]],
  ...
  const scenarioKeys=['hp','armor','enemyDamage','enemyInterval','targetTime','horizon','hitRate','coverage','energy','maxEnergy','regen','regenDelay','resourceLimits','shock'];
