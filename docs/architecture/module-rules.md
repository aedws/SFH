...
현재 맵 생성, 맵 방해물, 미니맵, 작전 선택, 시간 잠금 탈출, 크레딧, 파밍, 플레이어 이동·회피, 부분 체력 회복, 캐릭터 장비·무기 슬롯·스킬·방어구, 격자 인벤토리, 장비 개조·강화 경제, 적 체력·방어력 UI, 생성, 자동 무기, 무기 밸런스, 피해, 내부 경험치·버프 선택, 외부 성장, 게임오버 플래그가 실제 게임 조립에 연결되어 있습니다.
